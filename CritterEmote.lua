...
--Revision 1.11.2.05.01 (naming convention X.XX.X or XX.X if needed.XX where X=critter emote version.X=WOW Xpac.X or XX=WoW xpac sub.X = addt Xpac sub as needed. XX=update revision counting up as needed)
--WOW version 11.2.5
...
local CritterEmote_version = "1.11.2.05.01";
